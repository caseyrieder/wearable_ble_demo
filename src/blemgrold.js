...
class BLEMang extends Component {
  ...
  handleDisconnectedPeripheral(data) {
    ...
    if (peripheral) {
      ...
      this.setState({peripherals, paired: {}});
    }
      ...
      if (peripheral.connected) {
        ...
        BleManager.connect(peripheral.id).then(() => {
          ...
          if (p) {
            ...
            this.setState({peripherals, paired: peripherals[0]});
          }
          ...
          setTimeout(() => {
            ...
            BleManager.retrieveServices(peripheral.id).then(peripheralInfo => {
              ...
              setTimeout(() => {
                BleManager.write(peripheral.id, service, colorCharacteristic, [
                  'red motherfucker',
                ]).then(() => {
        ...
        <ScrollView style={styles.scroll}>
          {this.state.paired && (
            <View style={{flex: 1, margin: 20}}>
              <Text style={{textAlign: 'center'}}>Paired</Text>
